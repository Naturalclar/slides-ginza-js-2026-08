...
export const sections: Section[] = [
  ...
  },
  {
    ...
    note: "0:15–0:40 前振り兼つかみ。初めて勉強会に来た頃はESLintすら分かっていなかった、という具体で入る。経験を積むほど「これは当たり前」と思って話さなくなる、その感覚のズレの話。そのまま「だから今日は、派手な技術ではなく毎日の運用の話をします」でデモに入る。デモ開始は0:40目安（原稿の0:30から約10秒押し、回収は【削る順①】から）。押されたら口頭だけにしてこのスライドは飛ばす",
  },
  {
    id: "demo",
    content: <h1>デモ</h1>,
