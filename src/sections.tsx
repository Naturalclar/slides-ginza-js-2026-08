...
`}</pre>
  ...
  },
  {
    ...
    note: "7:50–9:00 まとめ。※7:20–7:50は予備枠。前半が押していればここで吸収され、押していなければ締めに間を取れる。【削る順③】後半は落とす前提。AIがコードを書く時代、作ること自体は安くなった。価値が残るのは、運用して初めて分かる失敗と、それを直すループを持っていること。押されていなくても後半は落とす。さらに押されたら1行目で締める",
  },
  {
    id: "thanks",
    content: (
